...
| Section | Description |
|----------|-------------|
| **Header** | Contains metadata (who sent it, type of message , how long it is). |
...
| **Message Type** | 1 | Defines if message is a Request, Response, or Notification |
| **Return Code** | 1 | Shows the execution status (OK, Error) |
...
1. **Service Announcement:**  
   ...
   → Example:announce Service with ID 0x1234 on IP 192.168.0.10, port 30509
